...
public class ResultsPage {
	...
	Image goodJob1 = new ImageIcon("backgrounds/GoodJob1.jpeg").getImage().getScaledInstance(memeWidth, memeHeight, Image.SCALE_DEFAULT);
	Image goodJob2 = new ImageIcon("backgrounds/GoodJob2.jpg").getImage().getScaledInstance(memeWidth, memeHeight, Image.SCALE_DEFAULT);
	Image goodJob3 = new ImageIcon("backgrounds/GoodJob3.jpg").getImage().getScaledInstance(memeWidth, memeHeight, Image.SCALE_DEFAULT);
	Image goodJob4 = new ImageIcon("backgrounds/GoodJob4.jpg").getImage().getScaledInstance(memeWidth, memeHeight, Image.SCALE_DEFAULT);
	Image goodJob5 = new ImageIcon("backgrounds/GoodJob5.png").getImage().getScaledInstance(memeWidth, memeHeight, Image.SCALE_DEFAULT);
	Image goodJob6 = new ImageIcon("backgrounds/GoodJob6.jpg").getImage().getScaledInstance(memeWidth, memeHeight, Image.SCALE_DEFAULT);
	Image goodJob7 = new ImageIcon("backgrounds/GoodJob7.jpg").getImage().getScaledInstance(memeWidth, memeHeight, Image.SCALE_DEFAULT);
	Image goodJob8 = new ImageIcon("backgrounds/GoodJob8.jpeg").getImage().getScaledInstance(memeWidth, memeHeight, Image.SCALE_DEFAULT);
	Image goodJob9 = new ImageIcon("backgrounds/GoodJob9.png").getImage().getScaledInstance(memeWidth, memeHeight, Image.SCALE_DEFAULT);
	Image goodJob10 = new ImageIcon("backgrounds/GoodJob10.jpg").getImage().getScaledInstance(memeWidth, memeHeight, Image.SCALE_DEFAULT);
	Image goodJob11 = new ImageIcon("backgrounds/GoodJob11.jpg").getImage().getScaledInstance(memeWidth, memeHeight, Image.SCALE_DEFAULT);

	Image okayJob1 = new ImageIcon("backgrounds/OkayJob1.jpg").getImage().getScaledInstance(memeWidth, memeHeight, Image.SCALE_DEFAULT);
	Image okayJob2 = new ImageIcon("backgrounds/OkayJob2.png").getImage().getScaledInstance(memeWidth, memeHeight, Image.SCALE_DEFAULT);
	Image okayJob3 = new ImageIcon("backgrounds/OkayJob3.jpeg").getImage().getScaledInstance(memeWidth, memeHeight, Image.SCALE_DEFAULT);
	Image okayJob4 = new ImageIcon("backgrounds/OkayJob4.jpg").getImage().getScaledInstance(memeWidth, memeHeight, Image.SCALE_DEFAULT);
	Image okayJob5 = new ImageIcon("backgrounds/OkayJob5.jpg").getImage().getScaledInstance(memeWidth, memeHeight, Image.SCALE_DEFAULT);
	Image okayJob6 = new ImageIcon("backgrounds/OkayJob6.jpg").getImage().getScaledInstance(memeWidth, memeHeight, Image.SCALE_DEFAULT);
	Image okayJob7 = new ImageIcon("backgrounds/OkayJob7.jpg").getImage().getScaledInstance(memeWidth, memeHeight, Image.SCALE_DEFAULT);
	//Image okayJob8 = new ImageIcon("backgrounds/OkayJob8.jpg").getImage().getScaledInstance(memeWidth, memeHeight, Image.SCALE_DEFAULT);
	Image okayJob9 = new ImageIcon("backgrounds/OkayJob9.jpg").getImage().getScaledInstance(memeWidth, memeHeight, Image.SCALE_DEFAULT);

	Image badJob1 = new ImageIcon("backgrounds/BadJob1.jpg").getImage().getScaledInstance(memeWidth, memeHeight, Image.SCALE_DEFAULT);
	Image badJob2 = new ImageIcon("backgrounds/BadJob2.png").getImage().getScaledInstance(memeWidth, memeHeight, Image.SCALE_DEFAULT);
	Image badJob3 = new ImageIcon("backgrounds/BadJob3.jpg").getImage().getScaledInstance(memeWidth, memeHeight, Image.SCALE_DEFAULT);
	Image badJob4 = new ImageIcon("backgrounds/BadJob4.jpg").getImage().getScaledInstance(memeWidth, memeHeight, Image.SCALE_DEFAULT);
	Image badJob5 = new ImageIcon("backgrounds/BadJob5.jpg").getImage().getScaledInstance(memeWidth, memeHeight, Image.SCALE_DEFAULT);
	Image badJob6 = new ImageIcon("backgrounds/BadJob6.jpg").getImage().getScaledInstance(memeWidth, memeHeight, Image.SCALE_DEFAULT);
	Image badJob7 = new ImageIcon("backgrounds/BadJob7.jpeg").getImage().getScaledInstance(memeWidth, memeHeight, Image.SCALE_DEFAULT);
	Image badJob8 = new ImageIcon("backgrounds/BadJob8.jpg").getImage().getScaledInstance(memeWidth, memeHeight, Image.SCALE_DEFAULT);
	Image badJob9 = new ImageIcon("backgrounds/BadJob9.jpg").getImage().getScaledInstance(memeWidth, memeHeight, Image.SCALE_DEFAULT);
